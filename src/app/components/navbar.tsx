          ...
          <div className="items-center hidden space-x-4 sm:flex">
            {!user ? (
              <>
                ...
                <RegisterLink className="font-medium flex bg-blue-700  text-white hover:bg-blue-500 px-3 py-2 rounded-lg">
                  Get Started{" "}
                  <BsArrowRight className="mt-[5px] ml-2"></BsArrowRight>
                </RegisterLink>
              </>
            ) : (
              <>
